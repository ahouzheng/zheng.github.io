...
- 服务调用方会从注册中心拉取服务提供方列表，以便发起服务时调用
- 有新的服务提供方变动，会通知到注册中心，然后注册中心将信息推送给服务调用方
...
Zookeeper允许客户端注册节点的监视（watcher）事件，在注册watcher后，节点的变化会通知到相应的客户端，客户根据这些时间执行相应的业务逻辑
...
- 集群管理，记录集群的退出和加入
- 命名服务，实现
- 配置管理，存贮全局的配置，当配置放生改变时，通过watcher机制通知到相关的客户端
- 分布式锁
